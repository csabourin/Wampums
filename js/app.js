...
const app = {
    ...
    async renderLoginPage() {
        const content = `
            ...
            <form id="login-form">
                <input type="email" name="email" placeholder="${this.translate('email')}" required>
            ...
            <p><a href="/register.php">${this.translate('create_account')}</a></p>
        `;
        ...
        try {
            ...
            let content = `
                ...
                <div class="manage-items">
                    <a href="/manage_points.php">${this.translate('manage_points')}</a>
                    <a href="/manage_honors.php">${this.translate('manage_honors')}</a>
                    <a href="/attendance.php">${this.translate('attendance')}</a>
                </div>
                <div id="points-list">
