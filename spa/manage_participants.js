import { getParticipants, getGroups, updateParticipantGroup } from './ajax-functions.js';
            ...
            <tr>
                ...
                <td data-label="${translate('group')}">
                    <select class="group-select" data-participant-id="${participant.id}">
                        <option value="" ${participant.group_id === null ? 'selected' : ''}>${translate('no_group')}</option>
