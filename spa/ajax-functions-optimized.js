...
async function makeApiRequest(endpoint, options = {}) {
    ...
    throw new Error(
        `Failed to complete API request after ${retries + 1} attempts: ${lastError.message}`,
    );
}

// Enhanced caching function
async function makeApiRequestWithCache(
    endpoint,
    options = {},
    cacheOptions = {},
) {
...
export const getParticipantsWithErrorHandling =
    withErrorHandling(getParticipants);
export const saveParticipantWithErrorHandling =
    withErrorHandling(saveParticipant);
...
export async function fetchParticipants(organizationId) {
    return API.get("parent-dashboard-data", {
        organization_id: organizationId,
    });
}
...
export async function linkParticipantToOrganization(
    participantId,
    organizationId,
) {
...
export async function removeParticipantFromOrganization(
    participantId,
    organizationId,
) {
