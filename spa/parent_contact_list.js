    ...
    renderContacts(contacts) {
        return contacts.map(contact => `
            <div class="contact-info">
                ...
                ${contact.is_emergency ? `<span class="emergency-contact">${translate('emergency_contact')}</span>` : ''}
                ${contact.phone_home ? `<span class="phone-number">${translate('phone_home')}: ${contact.phone_home}</span>` : ''}
                ${contact.phone_cell ? `<span class="phone-number">${translate('phone_cell')}: ${contact.phone_cell}</span>` : ''}
                ${contact.phone_work ? `<span class="phone-number">${translate('phone_work')}: ${contact.phone_work}</span>` : ''}
            </div>
        `).join('');
    }
